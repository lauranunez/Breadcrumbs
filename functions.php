function the_breadcrumbs() {
    ...
    if ( !is_front_page() ) {
        ...
        echo '<span id="breadcrums-custom' . $breadcrums_id . '" class="' . $breadcrums_class . '">';
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if(!empty($last_category)) {
                echo $cat_display;
                echo '<span class="item-current item-' . $post->ID . '"><span class="bread-current bread-' . $post->ID . '" title="' . get_the_title() . '">' . get_the_title() . '</strong></span>';
